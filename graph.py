...
class Graph:
    ...
    def __init__(self, edges):
        self.neighbors, self.n_nodes, self.adj_mat, self.nodes = self._init_from_edges(edges)

    @staticmethod
    def _init_from_edges(edges: np.ndarray) -> (Dict[int, Set[int]], int, sp.spmatrix,Set[int]):
        ...
        adj_mat += adj_mat.T
        return neighbors, n_nodes, adj_mat,nodes
